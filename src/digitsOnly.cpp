...
const byte fontSemicolon[][4] PROGMEM = {
	{0x00, 0x42, 0x24, 0x00}, //{0x00, 0x02, 0x40, 0x00}, // : 1 1st 0
	{0x00, 0x24, 0x42, 0x00}, //{0x00, 0x40, 0x02, 0x00}, // : 2 2st 
	{0x00, 0x20, 0x04, 0x00}, // : 3 3st
	{0x00, 0x04, 0x20, 0x00}, // : 4 4st 3
...
const byte fontMediumScript[][4] PROGMEM = {
	...
	{0x42, 0x81, 0x89, 0x76}, //{0x41, 0x89, 0x89, 0x77}, //{0x41, 0x89, 0x95, 0x63}, // 3
	{0x30, 0x2C, 0x22, 0xFF}, // 4
	{0x4F, 0x89, 0x89, 0x71}, // 5
	{0x7E, 0x91, 0x91, 0x62}, //{0x7E, 0x91, 0x91, 0x60}, // 6
