...
const uint8_t* Icons[] PROGMEM = {
	Sunny_M, 				// 0 Sunny
	MostlyClear_M,			// 1 Mostly Clear
	PartlyCloudy_M,			// 2 Partly Cloudy
	Cloudy_M,				// 3 Cloudy
	Foggy_M,				// 4 Foggy
	Umbrella_M,				// 5 Umbrella
	Rain_M,					// 6 Rain
	Snow_M,					// 7 Snow
	Thunderstorm_M,			// 8 Thunderstorm
	};
}
...
int16_t draw_weather_icon(uint32_t letter, int16_t offset, int16_t baseline) {
	...
	drawChar(WeatheIcons::Icons[icon]+(shift*12), offset, baseline, 12);
