...
const uint8_t fontVar[][6] PROGMEM = {
	...
	{0x28, 0x7C, 0x28, 0x7C, 0x28, 0x85}, // # 0x23 35 3
	...
	{0x10, 0x10, 0x7C, 0x10, 0x10, 0x85}, // + 0x2b 43 11
	{0xa0, 0x60, 0x00, 0x00, 0x00, 0x82}, // , 0x2c 44 12
	{0x10, 0x10, 0x10, 0x10, 0x10, 0x84}, // - 0x2d 45 13
	{0x60, 0x60, 0x00, 0x00, 0x00, 0x82}, // . 0x2e 46 14
	{0x20, 0x10, 0x08, 0x04, 0x02, 0x85}, // / 0x2f 47 15
	{0x7E, 0x81, 0x81, 0x81, 0x7E, 0x85}, // 0 0x30 48 16
	{0x00, 0x82, 0xFF, 0x80, 0x00, 0x85}, // 1 0x31 49 17
	{0x82, 0xC1, 0xA1, 0x91, 0x8E, 0x85}, // 2 0x32 50 18
	{0x41, 0x81, 0x89, 0x95, 0x63, 0x85}, // 3 0x33 51 19
	{0x30, 0x2C, 0x22, 0xFF, 0x20, 0x85}, // 4 0x34 52 20
	{0x4F, 0x89, 0x89, 0x89, 0x71, 0x85}, // 5 0x35 53 21
	{0x7C, 0x92, 0x91, 0x91, 0x60, 0x85}, // 6 0x36 54 22
	{0x01, 0xF1, 0x09, 0x05, 0x03, 0x85}, // 7 0x37 55 23
	{0x76, 0x89, 0x89, 0x89, 0x76, 0x85}, // 8 0x38 56 24
	{0x0E, 0x91, 0x91, 0x51, 0x3E, 0x85}, // 9 0x39 57 25
	{0x00, 0x66, 0x66, 0x00, 0x00, 0x84}, // : 0x3a 58 26
	{0x00, 0xA6, 0x66, 0x00, 0x00, 0x84}, // ; 0x3b 59 27
	{0x08, 0x14, 0x22, 0x41, 0x00, 0x84}, // < 0x3c 60 28
	{0x28, 0x28, 0x28, 0x28, 0x00, 0x84}, // = 0x3d 61 29
	...
	{0x7f, 0x49, 0x49, 0x36, 0x49, 0x84}, // B 0x42 66 34
	{0x3e, 0x41, 0x41, 0x22, 0x41, 0x84}, // C 0x43 67 35
	{0x7f, 0x41, 0x41, 0x3e, 0x41, 0x84}, // D 0x44 68 36
	...
	{0x7f, 0x08, 0x08, 0x7f, 0x08, 0x84}, // H 0x48 72 40
	...
	{0x3e, 0x41, 0x41, 0x3e, 0x41, 0x84}, // O 0x4f 79 47
	{0x7f, 0x09, 0x09, 0x06, 0x09, 0x84}, // P 0x50 80 48
	...
	{0x7F, 0x49, 0x49, 0x31, 0x71, 0x84}, // Б 96
	{0x7f, 0x49, 0x49, 0x36, 0x36, 0x84}, // В 97
	...
	{0x7f, 0x08, 0x08, 0x7f, 0x08, 0x84}, // Н 108
	{0x3e, 0x41, 0x41, 0x3e, 0x41, 0x84}, // О 109
	{0x7F, 0x01, 0x01, 0x7F, 0x01, 0x84}, // П 110
	{0x7f, 0x09, 0x09, 0x06, 0x09, 0x84}, // Р 111
	{0x3e, 0x41, 0x41, 0x22, 0x41, 0x84}, // С 112
	...
	{0x3C, 0x40, 0x20, 0x7C, 0x00, 0x84}, // и 135
	{0x3C, 0x41, 0x21, 0x7C, 0x00, 0x84}, // й 136
